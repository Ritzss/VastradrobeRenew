  ...
  return (
    <div className="min-h-screen not-dark:bg-[radial-gradient(circle_at_top,#fffdfd_0%,#fff8f8_35%,#fff4f4_100%)] px-6 md:px-16 py-16 pt-28">
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        {/* Profile Summary */}
        <div className="bg-[#1a1a1a] not-dark:bg-white rounded-4xl shadow-[0_30px_80px_rgba(149,127,106,0.15)]">
          <ProfileCard
            name={user?.username}
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {/* DETAILS */}
          <div className="md:col-span-2 bg-[#1a1a1a] not-dark:bg-white rounded-4xl shadow-[0_30px_80px_rgba(149,127,106,0.15)] p-8 space-y-6">
            <div>
          ...
          {/* ACTIONS */}
          <div className="bg-[#1a1a1a] not-dark:bg-white rounded-4xl shadow-[0_30px_80px_rgba(149,127,106,0.15)] p-8 space-y-4">
